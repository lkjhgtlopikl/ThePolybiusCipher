...
Label(frame3, text="Выберите язык:", background="white").grid(row=0, column=0, columnspan=2, sticky=W, pady=5)
...
Label(frame4, text="Выберите тип шифрования:", background="white", ).grid(row=0, column=0, columnspan=2, sticky=W,
                                                                          pady=5)
...
radio_en_sign = Radiobutton(frame4, text="Английский алфавит", value="Английский алфавит", variable=shifr,
                            background="white")
